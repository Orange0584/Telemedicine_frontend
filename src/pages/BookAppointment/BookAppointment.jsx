    ...
    return (
        <div className="flex justify-center items-center min-h-screen bg-gray-100 pt-[80px]">
            ...
            <form onSubmit={handleSubmit} className="bg-white sm:pt-0 pt-10 p-6 rounded shadow-md w-full max-w-lg">
                <h2 className="text-2xl font-bold mb-4 mt-5">Book an appointment</h2>
                {/* <div className="mb-4">
                ...
                {/* <div className="mb-4">
                    <label className="block text-gray-700 mb-2" htmlFor="">Choose Doctor</label>
                    <select id="doctors" className="bg-transparent border border-black/40 text-gray-900 text-sm rounded-lg mb-4 focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5  "
                        value={formData?.role}
                        onChange={(e) => {
                            handleDoc(e)
                        }}
